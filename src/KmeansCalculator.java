...
public class KmeansCalculator {
	 ...
	 * it's generated by randomly selecting N colors and put into a SimpleMatrix.
	 * Before put each initial color, check if there is already a same color in the
	 * SimpleMatrix, if there is, replace it with another distance color found in
	 * the image.
	 */
